        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-20">
          <Card className="bg-white p-7 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-gray-500 mt-1">
              Үнийн хувьд: жижиг бараа 1000төгрөгнөөс эхлэнэ. 1 кг ачаа 3000
              төг, жижиг бараа өмд, цамц, хувцас 3000-8000 төг, хайрцагтай ачаа,
              гутал, пүүз гэх мэт 5000 төгрөгнөөс эхлэнэ, овортой зузаан хувцас,
              куртик, хөвсгөр зүйлс мкуб ээр тооцно, 1м³ 450.000. Их хэмжээний
              бараа ..г.м үнэ тохиролцоно.
            </p>
          </Card>
          <Card className="bg-white p-7 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="flex flex-row justify-start items-center gap-5">
